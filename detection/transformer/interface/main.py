...
from detection.transformer.ml_logic.model import initialize_model, compile_model, train_model, evaluate_model
from detection.transformer.ml_logic.preprocessor import preprocess_data
from detection.transformer.ml_logic.registry import load_model, save_model, save_results
from detection.transformer.ml_logic.registry import mlflow_run, mlflow_transition_model
...
def train(
    ...
    if model is None:
        model = initialize_model(input_shape=(224,224,3))
